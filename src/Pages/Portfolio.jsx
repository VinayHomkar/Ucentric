...
// =========================================================================
// ⭐️ HOOK: For responsive inline styles (Copied from reference)
// =========================================================================
...
// =========================================================================
// ⭐️ HOOK: Mouse-follow glow effect (Copied from reference)
// =========================================================================
const useHoverGlow = () => {
...
        <button
            onClick={onClick}
            // Removed 'max-sm:hidden' to make button visible on mobile, ensuring full responsiveness
...
// =========================================================================
// ⭐️ PORTFOLIO FAQ COMPONENTS (Using reference structure)
// =========================================================================

// 1. The NEW Data for portfolios
const portfolioFaqs = [
    { q: "How long does it take to create a custom portfolio website?", a: "A typical portfolio website takes about 2-4 weeks from start to finish. This includes discovery, design, development, and revisions. More complex portfolios with unique features may take longer." },
    { q: "Can I update my portfolio myself after it's built?", a: "Yes! We build most portfolios on a user-friendly Content Management System (CMS) that allows you to easily add new projects, update your bio, and change images without any coding knowledge." },
    { q: "What do I need to provide to get started?", a: "To start, you'll need to provide your existing content (projects, images, case studies, resume/bio). If you don't have content, our 'Content & Copywriting' service can help you create it." },
    { q: "Do you provide hosting and maintenance?", a: "We offer separate hosting and maintenance packages to keep your portfolio secure, fast, and up-to-date. This includes regular backups, security scans, and support for minor updates." }
];
...
                {portfolioFaqs.map((faq, index) => ( // ⭐️ Changed to use portfolioFaqs
                    <NewFAQItem 
                        key={index}
                        faq={faq}
                        index={index}
...
        { icon: '🧠', title: "Consultation & Topic Finalization", desc: "We define your goals, target audience, and unique value proposition." },
        { icon: '📝', title: "Project Planning", desc: "Crafting your story and designing a stunning, user-centric interface." },
        { icon: '💻', title: "Development & Testing", desc: "Building a responsive, high-performance site with clean code." },
        { icon: '🗎', title: "Report & Documentation", desc: "Deploying your portfolio and ensuring everything is pixel-perfect." },
{ icon: '🚀', title: "Review & Launch", desc: "Deploying your portfolio and ensuring everything is pixel-perfect." },
    ];

    // Data for the "Services" section
    const portfolioServices = [
        { icon: '🎓', title: "College Students & Graduates", desc: "A unique design built from scratch to match your personal brand." },
        { icon: '💼', title: "Corporates & Small Businesses", desc: "Looks flawless on all devices, from mobile phones to desktops." },
        { icon: '🎥', title: "Influencers & Content Creators", desc: "We help you craft compelling project descriptions and a professional bio." },
        { icon: '🚀', title: "Personal Branding Professionals", desc: "Helping clients and recruiters find you online through search." },
        { icon: '🌟', title: "Celebrities & Public Figures", desc: "Beautiful, easy-to-manage galleries for your images, videos, and case studies." },
    { icon: '⚙️', title: "Custom portfolio", desc: "Easily update your own projects, or let us handle it for you." },
    ];
...
                        Create a stunning, professional portfolio that captures your unique talent and vision.
                    </p>
...
                        }}
                    >
                        A digital portfolio is your personal online gallery. It's more than a resume; it's a dynamic, interactive space to <b>showcase your best projects</b>, case studies, and skills. 
                    </p>
                    <p
                        style={{
                            fontSize: isMobile ? '1rem' : '1.15rem', 
...
                        }}
                    >
                       It allows you to <b>tell your professional story</b>, demonstrate your expertise, and provide tangible proof of your abilities to potential clients, employers, and collaborators.
                    </p>
                </div>
...
                            Capture attention instantly with a polished, professional online presence.
                        </p>
                    </AnimatedCard>
...
                    >
                        <p style={{ color: LIGHT_GREY, margin: 0, fontSize: '0.9rem' }}>
                           Show, don't just tell. Real projects build more trust than a resume alone.
                        </p>
                    </AnimatedCard>
...
                    >
                        <p style={{ color: LIGHT_GREY, margin: 0, fontSize: '0.9rem' }}>
                            A great portfolio is your 24/7 salesperson, converting visitors into opportunities.
                        </p>
                  </AnimatedCard>
...
                    >
                        <p style={{ color: LIGHT_GREY, margin: 0, fontSize: '0.9rem' }}>
                            Demonstrate the depth and breadth of your abilities through detailed case studies.
                        </p>
                    </AnimatedCard>
...
          >
                        <p style={{ color: LIGHT_GREY, margin: 0, fontSize: '0.9rem' }}>
                            Control your narrative and express your unique style, voice, and expertise.
                        </p>
                    </AnimatedCard>
                </div>
        </div>
...
                }}
       >
                <SectionTitle isMobile={isMobile} style={{ fontSize: isMobile ? '2rem' : '2.5rem', paddingTop: '0' }}>
...
                    }}
                >
                    Let's work together to create a stunning portfolio that gets you noticed and wins you the opportunities you deserve.
                </p>

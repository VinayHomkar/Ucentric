...
// =========================================================================
// ⭐️ NEW HOOK: For responsive inline styles
// =========================================================================
...
                transition: 'transform 0.5s ease-out, box-shadow 0.5s ease-out, opacity 0.5s ease-out' // Ensure transition is on base
            }}
        />
    );
};
...
const HoverableListItem = ({ children, baseStyle, hoverStyle, isLast = false, borderBottomStyle = '' }) => {
    const [isHovered, setIsHovered] = useState(false);
    return (
        <div
            onMouseEnter={() => setIsHovered(true)}
...
const AnimatedCard = ({ children, delay = 0, animationClass = '', imageSrc = '', icon = '', title = '', style = {} }) => { 
    
    // ⭐️ Add glow logic
...
                // ⭐️ Removed isVisible logic, set transform to hover-dependent only
                transform: isHovered ? 'translateY(-10px) scale(1.02)' : 'translateY(0) scale(1)',
                // ⭐️ Removed isVisible logic, set opacity to 1
                opacity: 1,
                // ⭐️ Removed isVisible logic, set filter to none
                filter: 'none',
                // ⭐️ Simplified transition
...
                {imageSrc && <img src={imageSrc} alt={title} style={{ width: '100%', borderRadius: '10px', marginBottom: '20px', maxHeight: '180px', objectFit: 'cover' }} />}
...
                    alignItems: 'center',
                    justifyContent: 'center',
                    boxShadow: visible ? '0 0 30px rgba(56,182,255,0.4)' : '0 0 20px rgba(56,182,255,0.25)', // Use 'visible' from hook
...
            >
                <GlowComponent />
                <div style={{ position: 'relative', zIndex: 10 }}> {/* ⭐️ Content above glow */}
...
const faqs = [
    { q: "How long does it take to design and develop an ecommerce website?", a: "The timeline for e-commerce development varies based on complexity, features, and customizations. A basic store might take 4-8 weeks, while a more complex platform could take 3-6 months. We provide a detailed project plan after understanding your requirements." },
    { q: "Can I update my ecommerce website on my own?", a: "Absolutely! We build our e-commerce platforms using user-friendly CMS (Content Management Systems) that allow you to easily add/edit products, manage content, process orders, and track sales without needing technical expertise." },
    { q: "Do you provide support after the website is launched?", a: "Yes, our commitment extends beyond launch. We offer various post-launch support and maintenance packages, including security updates, performance monitoring, bug fixes, and feature enhancements to ensure your site runs smoothly." },
     { q: "Can you integrate payment gateways for my ecommerce platform?", a: "Definitely. We integrate popular and secure payment gateways such as Stripe, PayPal, Razorpay, and custom solutions, ensuring smooth and secure transactions for your customers." }
];
...
            {/* Banner directly under Navbar (70vh using user-provided Freepik image) */}
            <div
                style={{
                    width: '100%',
...
                        animate-gradient
                        "
                        // ⭐️ The Tailwind classes are already responsive, so no inline fontSize needed
                    >
                        Elevate Your Business with Smart Ecommerce Solutions
                    </h1>


                    <p style={{ color: LIGHT_GREY, marginTop: '12px', fontSize: isMobile ? '0.95rem' : '1.05rem' }}>
                        Build a powerful, scalable online store with Ucentric — crafted to boost sales and grow your digital presence.
                    </p>

                    {/* ✅ MODIFICATION: Button is centered and linked to /Contact */}
                    <div style={{ marginTop: '18px', display: 'flex', justifyContent: 'center' }}>
                        <AnimatedButton onClick={() => window.location.href = '/Contact'}>Get a Free Consultation →</AnimatedButton>
                    </div>
                </div>
            </div>
...
                    position: 'relative',
                    overflow: 'hidden',
                    // Background kept but section minimized so banner is primary hero
...
                {/* (These require @keyframes in a CSS file to work) */}
                <div style={{ position: 'absolute', top: '10%', left: '5%', width: '150px', height: '150px', backgroundColor: ACCENT_BLUE + '30', borderRadius: '50%', filter: 'blur(50px)', animation: 'float 8s ease-in-out infinite alternate' }}></div>
                <div style={{ position: 'absolute', bottom: '15%', right: '10%', width: '200px', height: '200px', backgroundColor: DEEP_BLUE + '50', borderRadius: '50%', filter: 'blur(70px)', animation: 'float 10s ease-in-out infinite alternate-reverse' }}></div>
                <div style={{ position: 'absolute', top: '30%', right: '25%', width: '100px', height: '100px', backgroundColor: ACCENT_BLUE + '40', borderRadius: '50%', filter: 'blur(40px)', animation: 'float 12s ease-in-out infinite' }}></div>

                {/* Hero text removed — content moved to the banner under the Navbar */}
            </div>
...
                    }}
                >
                    {/* ⭐️ Restored SectionTitle and made it responsive */}
                    <SectionTitle isMobile={isMobile} style={{ paddingTop: 0, whiteSpace: 'normal' }}>
                        <span className="bg-gradient-to-r from-[#38b6ff] to-[#000433] bg-clip-text text-transparent animate-gradient">
...
                {/* Your cards section starts here */}
                {/* Cards Container */}
                <div
                    style={{
                        display: 'flex',
...
                >
                    {/* ⭐️ AnimatedCard now has the glow logic built-in AND accepts the style prop */}
                    <AnimatedCard
                        delay={0}
                        icon="🌍"
...
                            textAlign: 'left',
                            marginTop: '0',
                            // ⭐️ Font size is now handled *inside* SectionTitle
                            fontWeight: 800,
                        }}
                    >
                        Intuitive &{' '}
...
                        successful online store. Our focus is on creating <b>user-friendly experiences</b> with seamless navigation, powerful search capabilities, and a streamlined checkout process. We craft <b>visually appealing designs</b> using high-quality images and engaging visuals to capture your audience.
                 </p>
                    <p
                        style={{
                            fontSize: isMobile ? '1rem' : '1.15rem', // ⭐️ Responsive font
...
                        With the majority of shopping happening on mobile, we ensure all our
                       e-commerce websites are <b>fully mobile-responsive</b>, providing a flawless
                        experience across all devices. Your customers will enjoy secure and
                        reliable shopping every time.
                    </p>
...
                    {[
                        { icon: '💡', title: "Discovery & Planning", desc: "Understanding your business goals, target audience, and setting a clear roadmap." },
                        { icon: '📊', title: "Market Strategy", desc: "Analyzing competitors and trends to form a unique, data-driven ecommerce approach." },
                      { icon: '🎨', title: "Design Phase", desc: "Crafting stunning, user-centric interfaces that capture your brand identity." },
                        { icon: '💻', title: "Development", desc: "Building a secure, high-performance platform with React, PHP, and MySQL." },
                        { icon: '🧠', title: "Code Review", desc: "Optimizing and refining every line of code for scalability and efficiency." },
                        { icon: '🔍', title: "Testing & QA", desc: "Rigorous functionality, performance, and security testing before launch." },
                        { icon: '🚀', title: "Launch", desc: "Seamless deployment ensuring smooth go-live and system stability." },
                        { icon: '🛡️', title: "Support", desc: "Continuous updates, monitoring, and technical support post-launch." },
                    ].map((step, index) => (
...
                    {[
                        { icon: '🛍️', title: "Product Catalog Management", desc: "Organize and manage products with rich visuals, filters, and detailed listings." },
                        { icon: '💳', title: "Payment Gateway Integration", desc: "Integrate Razorpay, Stripe, or PayPal securely with seamless checkout flow." },
                        { icon: '👥', title: "Customer Management", desc: "Manage user profiles, preferences, and order history for personalized experiences." },
                        { icon: '📊', title: "Admin Dashboard", desc: "Centralized control panel to manage users, content, and analytics efficiently." },
                        { icon: '📈', title: "Marketing & SEO", desc: "Boost visibility with SEO tools, coupons, and promotional integrations." },
                        { icon: '🛡️', title: "Advanced Security", desc: "Enterprise-grade encryption, SSL, and firewall protection for customer safety." },
                    ].map((service, index) => (

...
                {imageSrc && <img src={imageSrc} alt={title} style={{ width: '100%', borderRadius: '10px', marginBottom: '20px', height: '180px', objectFit: 'cover' }} />}
                {icon && <div style={{ fontSize: ICON_SIZE, color: ACCENT_BLUE, marginBottom: '20px' }}>{icon}</div>}
                {title && <h3 style={{ color: ACCENT_BLUE, marginBottom: '15px', fontSize: '1.5rem', fontWeight: '700', minHeight: '3rem' }}>{title}</h3>}
                {children}
            </div>
        </div>
    );
...
const ProcessStepCard = ({ step, index, isMobile, totalSteps }) => { // ⭐️ MODIFIED: Changed 'isLast' to 'totalSteps'
...
const faqs = [
    { q: "Can you help with both mini and final-year projects?", a: "Yes, we provide end-to-end guidance for all types of academic projects, including mini-projects for specific semesters and major final-year projects." },
    { q: "Do you provide project documentation?", a: "Absolutely. We provide complete documentation, including the project report, synopsis, presentations (PPTs), and system architecture diagrams as required by your college." },
    { q: "What technologies can I choose for my project?", a: "You can choose from a wide range, including Web (MERN, MEAN), Android, Python (AI, ML, Data Science), IoT, and Cloud. We will help you select the best one based on your interests and curriculum." },
    { q: "How long does it take to complete a project?", a: "A mini-project might take 1-2 weeks, while a final-year project typically takes 4-6 weeks, depending on the complexity. We ensure on-time delivery before your deadline." },
    { q: "Can you assist with presentation and viva preparation?", a: "Yes! Our service includes helping you understand the code and project flow, preparing for your presentation, and covering potential viva questions." }
];
...
    const whyUcentric = [
        { icon: '👨‍🏫', title: "End-to-End Guidance", desc: "From topic selection to final viva, we guide you at every single step." },
        { icon: '🚀', title: "Real-World Tech Stack", desc: "Work on technologies that companies actually use, like React, Node, and Python." },
        { icon: '📄', title: "Reports & PPT Assistance", desc: "Get professionally written project reports, documentation, and presentations." },
        { icon: '⏳', title: "On-Time Delivery", desc: "We guarantee your project is completed and delivered well before your deadline." },
        { icon: '💰', title: "Affordable for Students", desc: "Special packages and pricing designed specifically to fit a student's budget." },
    ];
...
    const projectTypes = [
        { icon: '🌐', name: "Web Development", desc: "Full-stack web apps, e-commerce sites, and portals using MERN/MEAN stack." },
        { icon: '🤳', name: "Android Development", desc: "Native Android apps for various business, utility, or entertainment purposes." },
        { icon: '🤖', name: "Software Development Projects", desc: "Projects involving predictive models, NLP, computer vision, and deep learning." },
        { icon: '🔌', name: "Final-Year / Mini Projects", desc: "we create final year projects based on your requirment" },
        { icon: '📈', name: "Data Analytics", desc: "Data visualization, business intelligence dashboards, and big data processing." },
        { icon: '🗂️', name: "Academic Project Documentation", desc: "Comprehensive reports, research papers, and project documentation for students." },
      { icon: '🎨', name: "UI/UX Design Projects", desc: "Creative design interfaces and prototypes with a user-first approach." },
...
        { icon: '💬', title: "Consultation", desc: "We discuss your ideas, requirements, and finalize the project topic." },
        { icon: '📝', title: "Project Planning", desc: "We create a detailed plan, architecture, and timeline for your project." },
        { icon: '💻', title: "Development & Testing", desc: "Our developers build your project, followed by rigorous testing." },
      { icon: '📚', title: "Report & Documentation", desc: "We prepare the complete project report, synopsis, and PPT." },
        { icon: '🏁', title: "Review & Submission", desc: "You review the final project and submit it with confidence." }
    ];

    // 6. Featured Projects
    const featuredProjects = [
        { img: 'https://images.unsplash.com/photo-1554492652-92c2f0f7f038?q=80&w=1974&auto=format&fit=crop', title: "Smart Attendance System", desc: "An AI-based system using facial recognition to automate attendance." },
      { img: 'https://images.unsplash.com/photo-1557821552-17105176677c?q=80&w=1932&auto=format&fit=crop', title: "E-commerce Web App", desc: "A full-stack MERN project with payment gateway and admin panel." },
        { img: 'https://images.unsplash.com/photo-1534972195531-c0f30d0e127c?q=80&w=2070&auto=format&fit=crop', title: "AI Chatbot for Colleges", desc: "An NLP-powered chatbot to answer student queries 24/7." },
        { img: 'https://images.unsplash.com/photo-1518444065439-e933c06ce9cd?q=80&w=1974&auto=format&fit=crop', title: "IoT Smart Home Automation", desc: "Control home appliances using a mobile app and IoT sensors." },
    ];
...
                    <p style={{ color: LIGHT_GREY, marginTop: '12px', fontSize: isMobile ? '1rem' : '1.15rem' }}>
                        From idea to implementation — we help students and graduates turn academic visions into impactful digital solutions.
                    </p>

                    {/* ⭐️ CHANGED: Added flex and justify-center to center the button */}
                    <div style={{ marginTop: '18px', display: 'flex', justifyContent: 'center' }}>
                        <AnimatedButton onClick={() => navigate('/contact')}> {/* ⭐️ CHANGED */}
                            Start Your Project →
                        </AnimatedButton>
                    </div>
                </div>
...
            {/* ========================================================================= */}
            <div style={{ padding: isMobile ? '60px 5%' : '80px 5%', textAlign: 'center' }}>
...
                    opacity: 0.9,
                }}>
                     Ucentric provides complete assistance in college and final-year projects. Our service includes everything from <b>project planning and topic selection</b> to <b>development, testing, documentation, and presentation</b>. We ensure you not only get a high-quality project but also understand it thoroughly. We cover a vast array of technologies including <b>Web Development, Android,Data analytics,HTML, CSS, JavaScript, PHP, MySQL, React, Flutter, and Android.</b>.
                </p>
            </div>
            {/* ========================================================================= */}
...
                    <p style={{ color: LIGHT_GREY, marginTop: '12px', fontSize: isMobile ? '1rem' : '1.15rem' }}>
                        Get professional guidance, quality code, and perfect documentation — all in one place.
                    </p>

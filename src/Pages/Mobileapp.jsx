...
const Mobileapp = () => {
  ...
  const processSteps = [
    { icon: '💡', title: "Discovery & Strategy", desc: "Understand goals, users, and scope to build a clear plan." },
    { icon: '🎨', title: "UI/UX Design", desc: "Design user flows and interfaces that delight." },
    { icon: '💻', title: "Development", desc: "Build with performance, structure and best practices." },
    { icon: '🔍', title: "Testing & QA", desc: "Comprehensive testing across devices and scenarios." },
    { icon: '🚀', title: "Deployment & Support", desc: "Launch and provide continued support & updates." },
  ];

  const appServices = [
    { icon: '📱', title: "Custom App Development", desc: "Native & cross-platform apps built to fit your needs." },
    { icon: '🎨', title: "App UI/UX Design", desc: "Human-centered designs that drive engagement." },
    { icon: '🛠️', title: "Maintenance & Support", desc: "Ongoing updates, monitoring and improvements." },
  ...
  return (
    <div style={{ backgroundColor: BACKGROUND_BLACK, color: TEXT_WHITE, minHeight: '100vh', fontFamily: 'Inter, Arial, sans-serif', overflowX: 'hidden' }}>
      ...
      >
        <div style={{ maxWidth: 1100, padding: isMobile ? '0 16px' : '0 24px' }}>
          <h1
          ...
          <p style={{ color: LIGHT_GREY, marginTop: 12, fontSize: isMobile ? '1rem' : '1.15rem', maxWidth: 700, marginLeft: 'auto', marginRight: 'auto' }}>
            We build engaging, scalable, and high-performance mobile apps tailored to your brand.
          </p>

          <div style={{ marginTop: 18, display: 'flex', justifyContent: 'center' }}>
            <AnimatedButton onClick={() => navigate('/contact')}>Get Started →</AnimatedButton>
          </div>
        </div>
      </div>
      ...
      {/* ========================================================================= */}
      <div style={{ padding: isMobile ? '50px 5%' : '80px 5%', textAlign: 'center' }}>
        <SectionTitle isMobile={isMobile}>
          <span style={{ background: `linear-gradient(90deg, ${ACCENT_BLUE}, ${DEEP_BLUE})`, WebkitBackgroundClip: 'text', color: 'transparent' }}>
            What We Do
          </span>
        </SectionTitle>
        <AccentDivider />

        <p style={{ color: LIGHT_GREY, fontSize: isMobile ? '1rem' : '1.05rem', maxWidth: 900, margin: '0 auto 40px', lineHeight: 1.7 }}>
          Ucentric specializes in developing cutting-edge iOS, Android, and cross-platform mobile apps. Our process is built on a foundation of exceptional UI/UX design and engineering best-practices for scale.
        </p>
        ...
        <div style={{ 
          ...
          <TechStackCard tech={{ icon: '', name: 'iOS Development', desc: 'Swift, UIKit & SwiftUI' }} />
          <TechStackCard tech={{ icon: '🤖', name: 'Android Development', desc: 'Kotlin & Jetpack Compose' }} />
          <TechStackCard tech={{ icon: '🔄', name: 'Cross-Platform', desc: 'React Native & Flutter' }} />
        </div>
      </div>
      {/* ========================================================================= */}
    ...
    {/* WHY CHOOSE */}
      <div style={{ padding: '40px 5%' }}>
        ...
        <div style={{
          ...
          <AnimatedCard delay={0} icon="🎨" title="User-Centered Design">
            <p style={{ color: LIGHT_GREY, margin: 0 }}>We design for your users — focusing on engagement and ease-of-use.</p>
          </AnimatedCard>
          <AnimatedCard delay={100} icon="💻" title="Latest Tech Stack">
            <p style={{ color: LIGHT_GREY, margin: 0 }}>React Native, Flutter, Swift & Kotlin — chosen to fit your product needs.</p>
          </AnimatedCard>
          <AnimatedCard delay={200} icon="⚡️" title="Agile Development">
            <p style={{ color: LIGHT_GREY, margin: 0 }}>Iterative sprints, continuous feedback, and fast delivery.</p>
          </AnimatedCard>
          <AnimatedCard delay={300} icon="🚀" title="Full Lifecycle Support">
            <p style={{ color: LIGHT_GREY, margin: 0 }}>From idea to launch and beyond — we partner for success.</p>
          </AnimatedCard>
          <AnimatedCard delay={400} icon="🛠️" title="Post-Launch Maintenance">
            <p style={{ color: LIGHT_GREY, margin: 0 }}>Monitoring, updates and feature growth to keep your app healthy.</p>
          </AnimatedCard>
        </div>
      </div>
      ...
      <div style={{ 
        ...
        <p style={{ color: LIGHT_GREY, fontSize: isMobile ? '1rem' : '1.05rem', maxWidth: 700, margin: '0 auto 20px', lineHeight: 1.7 }}>
          Ready to start your project? Get in touch with our team of app development experts today and let's discuss your vision.
        </p>

        <AnimatedButton onClick={() => navigate('/contact')}>Start Project →</AnimatedButton>
      </div>

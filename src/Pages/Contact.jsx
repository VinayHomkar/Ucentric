...
const Contact = () => {
  ...
  return (
    <div className="bg-black min-h-screen text-white">
      ...
      <section className="relative px-6 sm:px-10 lg:px-16 bg-black text-center lg:text-left">
        {/* Gradient Heading */}
        ...
        {/* Info Cards */}
        <div
          className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 max-w-7xl mx-auto text-gray-300 relative z-10"
